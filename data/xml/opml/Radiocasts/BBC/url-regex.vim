...
1,$s/<div class="[^"]\+podcastcell">.*<h3><a href="\/radio\([^"]\+\)">\([^<]\+\)<\/a><\/h3>.*[\r\n\t\ ]\+.*/\r\t\t<outline title="<!\[CDATA\[\2\]\]>" xmlUrl="http:\/\/downloads\.bbc\.co\.uk\/radio4\1rss\.xml" type="rss" htmlUrl="http:\/\/www\.bbc\.co\.uk\/radio\1" text="<!\[CDATA\[\2\ from\ the\ BBC\&#039;\ Radio4\]\]>" description="<!\[CDATA\[\2\ from\ the\ BBC\&#039;\ Radio4\]\]>"\/>/g

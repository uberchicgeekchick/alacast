...
triggerParms["displayMode"] = 1; //0=disable, 1=default popup then dhtml, 2=popup only, 3=dhtml only
triggerParms["mid"] = "E7F+G5PzBw1jexbIZ+IdMw=="; // model instance id
triggerParms["cid"] = "ZXGYhi2NdQUwucRgKXYsJQ"; // customer id
...
triggerParms["lfcookie"] = "ForeseeLoyalty_MID_E7F+G5PzBw";
triggerParms["ascookie"] = "ForeseeSurveyShown_E7F+G5PzBw";
triggerParms["width"] = 450; // survey width
triggerParms["height"] = 500; // survey height
triggerParms["domain"] = ".nasa.gov"; // domain name
...
triggerParms["dhtmlURL"]= "http://www.nasa.gov/survey/FSRInvite.html";
...
triggerParms["captureTriggerVersion"] = "STD3.2.3";	// track latest trigger version

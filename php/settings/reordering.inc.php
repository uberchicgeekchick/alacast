<?php
	...
	return array(
		...
		array(
			...
			array( '/([^a-zA-Z0-9])([0-9])([^a-zA-Z0-9])/', '${1}0$2$3' ),
			array( '/([^a-zA-Z0-9])([0-9])$/', '${1}0$2' ),
			array( '/(8)(een)/i', '1$1' ),
			array( '/(8)(y)/i', '${1}0' ),
			array( '/0([1-9])(teen)/i', '1$1' ),
			array( '/0([2-9])(ty)/i', '${1}0' ),
			'total'=>6,
		),
		array(
			array( '/ I /i', ' 1 ' ),
